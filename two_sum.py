...
class Solution:
    ...
    # now we move to the next number in the list. so now.. 7-4 is 3. we look in the hashmap for the value of 3, but we don't find it because currently the only thing that exists is 5. again, we add the value 4 to index 1, and move to the next number in the list. So far our hashmap looking like {2:0, 4:1,}.
